...
# <span style="color: coral3;">Section 1. Creating the post-stratification frame</span>
...
```{r}
# Load the data
poststrat <- read.csv("poststrat.csv")
# Rename the columns
...
# <span style="color: coral3;">Section 2. Estimating support for each party</span>


## <span style="color: #EE6A50;">2.1. Loading the survey data</span> {#bes}
...
## <span style="color: #EE6A50;">2.2. Modelling party vote intention</span> {#mlmvote}
...
## <span style="color: #EE6A50;">2.3. Predicting probabilities of voting for each party</span> {#predprobvote}
...
# <span style="color: coral3;">Section 3. Estimating voter turnout</span>
...
## <span style="color: #EE6A50;">3.1. Loading the random probability survey data</span> {#rps}
...
## <span style="color: #EE6A50;">3.2. Modelling voter turnout</span> {#mlmturnout}
...
## <span style="color: #EE6A50;">3.3. Predicting probabilities of voting</span> {#predprobturnout}
...
# <span style="color: coral3;">Section 4. Post-stratification</span>

## <span style="color: #EE6A50;">4.1 Calculate weighted predictions based on `perc` and `turnout`</span> {#weightedpred}
...
# <span style="color: coral3;">Section 5. Scaling estimates</span>
...
## <span style="color: #EE6A50;">5.1. Function to post-stratify by constituency code</span> {#poststrat}
...
## <span style="color: #EE6A50;">5.2. Scaling estimates with true results</span> {#scaleest}
...
### Getting Mean Absolute Error (MAE) for each party
```{r}
...
# <span style="color: coral3;">Section 6. References</span>
